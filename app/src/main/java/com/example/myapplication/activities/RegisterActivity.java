        ...
        BtnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (strFirstName.isEmpty() && strLastName.isEmpty() && strEmail.isEmpty() && strPassword.isEmpty()){
                    Toast.makeText(getApplicationContext(), "Alanlar Boş Girilemez!", Toast.LENGTH_LONG).show();
                    return;
                }
                else
                {
                    ...
                    auth.createUserWithEmailAndPassword(strEmail,strPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                                        ...
                                                        userCollectionRef.document(strEmail).set(user)
                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    ...
                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                        if(task.isSuccessful()){
                                                                            Toast.makeText(getApplicationContext(), "Kayıt basarilı!", Toast.LENGTH_LONG).show();
                                ...
                                Toast.makeText(getApplicationContext(), "bu kullanıcı var!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
